...
## Helpful links
<a href="https://www.python.org/downloads/">Download Python (Windows, macOS, and Linux) – python.org</a>

<a href="https://code.visualstudio.com/docs/python/python-tutorial">Create a Python console application using Visual Studio Code – VS Code Docs</a>

<a href="https://docs.python.org/3/tutorial/">A Tour of Python – Python Tutorial (official docs)</a>
